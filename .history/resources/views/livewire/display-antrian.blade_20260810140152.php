    ...
    <div class="flex h-screen flex-col bg-[radial-gradient(circle_at_top,_rgba(59,130,246,0.12),_transparent_35%),linear-gradient(180deg,_#f8fafc_0%,_#eef2ff_100%)]">
        ...
        <main class="flex-1 overflow-hidden p-4 xl:p-6">
            <div class="mx-auto flex h-full w-full max-w-[1600px] flex-col gap-5">
                ...
                <section class="flex min-h-0 flex-[1.4] overflow-hidden rounded-[2rem] border border-blue-100 bg-white shadow-xl shadow-blue-100/60">
                    ...
                    <div class="h-[calc(100%-76px)] overflow-y-auto px-5 py-6 pb-14 scroll-smooth">
                        <div class="flex flex-col gap-6">
                            @forelse($dinasSummaries as $summary)
                                <article class="flex min-h-[300px] flex-col overflow-hidden rounded-[1.75rem] border border-slate-100 bg-slate-50 shadow-sm">
                                    ...
                                    <div class="grid flex-1 gap-4 px-5 py-5 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
